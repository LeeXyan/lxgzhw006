...
class UserProfile(AbstractUser):
    ...
    user_image = models.ImageField(upload_to="image/user/%Y/%m", default="image/user/default.png", max_length=100,
                                   verbose_name=u"用户头像")
...
class Article(models.Model):
    ...
    article_image = models.ImageField(upload_to="image/article/%Y/%m", default="image/article/default.png",
    ...
    article_type = models.CharField(max_length=10, choices=(("0", u"草稿"), ("1", "软删除"), ("2", "正常")), default="0",
                                    verbose_name=u"文章类别")
    ...
    article_up = models.CharField(max_length=10, choices=(("1", u"置顶"), ("0", "取消置顶")), default="0",
                                  verbose_name=u"文章置顶")
    article_support = models.CharField(max_length=10, choices=(("1", u"推荐"), ("0", "取消推荐")), default="0",
                                       verbose_name=u"文章推荐")
...
class Siteinfo(models.Model):
    ...
    site_user = models.ForeignKey(UserProfile, verbose_name=u'管理员', null=True, blank=True,
                                  on_delete=models.CASCADE)
    site_logo = models.ImageField(upload_to="image/site/", default="image/site/default.png", max_length=100,
                                  verbose_name=u"站点logo")
    site_topimage = models.ImageField(upload_to="image/site/", default="image/site/topbg.jpg", max_length=100,
                                      verbose_name=u"顶部大图")
...
class Acimage(models.Model):
    ...
    image_path = models.ImageField(upload_to="upload/%Y/%m", default="upload/default.jpg", max_length=100,
                                   verbose_name=u"图片")
