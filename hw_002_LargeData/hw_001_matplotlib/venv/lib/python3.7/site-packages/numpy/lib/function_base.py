...
def interp(x, xp, fp, left=None, right=None, period=None):
    ...
    >>> plt.plot(x, y, 'o')
    [<hw_001_matplotlib.lines.Line2D object at 0x...>]
...
def blackman(M):
    ...
    <hw_001_matplotlib.text.Text object at 0x...>
    ...
    >>> plt.figure()
    <hw_001_matplotlib.figure.Figure object at 0x...>
...
def bartlett(M):
    ...
    Plot the window and its frequency response (requires SciPy and hw_001_matplotlib):
...
def sinc(x):
    ...
    <hw_001_matplotlib.image.AxesImage object at 0x...>
